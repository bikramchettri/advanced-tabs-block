			...
			<div className="atbs__inputs_group">
				{device === 'desktop' && (
					<div className="atbs_input__controls">
						<NumberControl
							...
							value={dLinked ? dLinkedValue : dTop}
							onChange={(value) => {
								setAttributes(
									dLinked
										? {
												[dLinkedValueAttr]: value,
										  }
										: {
												[dTopAttr]: value,
										  }
						...
						<NumberControl
							...
							value={dLinked ? dLinkedValue : dRight}
							onChange={(value) => {
								setAttributes(
									dLinked
										? {
						...
						<NumberControl
							...
							value={dLinked ? dLinkedValue : dBottom}
							onChange={(value) => {
								setAttributes(
									dLinked
										? {
						...
						<NumberControl
							...
							value={dLinked ? dLinkedValue : dLeft}
							onChange={(value) => {
								setAttributes(
									dLinked
										? {
						...
						>
							<Icon
								icon={`${
									dLinked ? 'admin-links' : 'editor-unlink'
								}`}
							/>
						</button>
					</div>
				...
				{device === 'tablet' && (
					<div className="atbs_input__controls">
						<NumberControl
							label={__('Top', 'advanced-timeline-block')}
							value={tLinked ? tLinkedValue : tTop}
							onChange={(value) => {
								setAttributes(
									tLinked
										? {
												[tLinkedValueAttr]: value,
										  }
										: {
												[tTopAttr]: value,
										  }
						...
						<NumberControl
							label={__('Right', 'advanced-timeline-block')}
							value={tLinked ? tLinkedValue : tRight}
							onChange={(value) => {
								setAttributes(
									tLinked
										? {
						...
						<NumberControl
							label={__('Bottom', 'advanced-timeline-block')}
							value={tLinked ? tLinkedValue : tBottom}
							onChange={(value) => {
								setAttributes(
									tLinked
										? {
						...
						<NumberControl
							label={__('Left', 'advanced-timeline-block')}
							value={tLinked ? tLinkedValue : tLeft}
							onChange={(value) => {
								setAttributes(
									tLinked
										? {
						...
						>
							<Icon
								icon={`${
									tLinked ? 'admin-links' : 'editor-unlink'
								}`}
							/>
						</button>
					</div>
				...
				{device === 'mobile' && (
					<div className="atbs_input__controls">
						<NumberControl
							label={__('Top', 'advanced-timeline-block')}
							value={mLinked ? mLinkedValue : mTop}
							onChange={(value) => {
								setAttributes(
									mLinked
										? {
												[mLinkedValueAttr]: value,
										  }
										: {
												[mTopAttr]: value,
										  }
						...
						<NumberControl
							label={__('Right', 'advanced-timeline-block')}
							value={mLinked ? mLinkedValue : mRight}
							onChange={(value) => {
								setAttributes(
									mLinked
										? {
						...
						<NumberControl
							label={__('Bottom', 'advanced-timeline-block')}
							value={mLinked ? mLinkedValue : mBottom}
							onChange={(value) => {
								setAttributes(
									mLinked
										? {
						...
						<NumberControl
							label={__('Left', 'advanced-timeline-block')}
							value={mLinked ? mLinkedValue : mLeft}
							onChange={(value) => {
								setAttributes(
									mLinked
										? {
						...
						>
							<Icon
								icon={`${
									mLinked ? 'admin-links' : 'editor-unlink'
								}`}
							/>
						</button>
					</div>
